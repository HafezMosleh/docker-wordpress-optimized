...
PROJECT_NAME="docker-wordpress-optimized"
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
PROJECT_DIR="$(cd "$SCRIPT_DIR/.." && pwd)"
cd "$PROJECT_DIR"

origin_url="$(git remote get-url origin 2>/dev/null || echo 'https://github.com/HafezMosleh/docker-wordpress-optimized.git')"
